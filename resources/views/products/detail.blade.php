...
<section class="content appTuyenSinh">
    ...
    <form class="form-horizontal " action="{{route('route_BackEnd_Products_Update', ['id' =>request()->route('id')])}}" method="post" enctype="multipart/form-data">
        @csrf
        <div class="box-body">
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-8">
                            <textarea name="description" id="description" rows="20" cols="10" class="form-control">{{$objItem->description}}</textarea>
                            <span id="mes_sdt"></span>
                        </div>
                    </div>
                    <div class="form-group">
        ...
        <div class="text-center">
            ...
            <a href="{{ route('route_BackEnd_Products_index') }}" class="btn btn-default">Cancel</a>
        </div>
        <!-- /.box-footer -->
    </form>
