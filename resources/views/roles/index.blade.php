                ...
                <div class="col-xs-12" style="text-align:center;">
                    <div class="form-group">
                        ...
                        <a href="{{ url('/user') }}" class="btn btn-default btn-sm "><i class="fa fa-remove"></i>
                            Clear </a>
                        <a href="/roles/add" class="btn btn-info btn-sm"><i class="ion-ios-list" style="color:white;"></i>
                            Add new</a>
                    </div>
                </div>
            </div>
            ...
            <div class="double-scroll">
                <table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <td class="text-center"><a class="btn btn-info ion-edit" href="{{route('route_BackEnd_Roles_Detail', ['id'=> $item->id])}}"></a></td>
                        <td class="text-center"><a onclick="return confirm('Bạn có muốn xoá')" class="btn btn-danger ion-trash-a" href="{{route('route_BackEnd_Roles_Delete', ['id'=> $item->id])}}"></a></td>
                    </tr>
                    @endforeach
