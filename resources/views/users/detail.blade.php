                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-8">
                            <input type="text" name="username" id="username" class="form-control" value="{{$objItem->username}}">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-8">
                            <img id="mat_truoc_preview" src="{{ $objItem->avatar?''.Storage::url($objItem->avatar):'http://placehold.it/100x100' }}" alt="your image" style="max-width: 200px; height:100px; margin-bottom: 10px;" class="img-responsive" />
                            <label for="cmt_truoc">Mặt trước</label><br />
                            <input type="file" name="avatar" id="avatar" class="form-control" value="{{$objItem->avatar}}">
                            <span id="mes_sdt"></span>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-8">
                            <input type="text" name="phoneNumber" id="phoneNumber" class="form-control" value="{{$objItem->phoneNumber}}">
                            <span id="mes_sdt"></span>
                        </div>
                    </div>
                    <div class="form-group">
