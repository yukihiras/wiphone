...
{{--                <li>--}}
{{--                    <a href="single-product.html" class="image"><img src="{{asset('clientBunker')}}/images/product-image/1.webp" alt="Cart product Image"></a>--}}
{{--                    <div class="content">--}}
...
{{--                </li>--}}
{{--                <li>--}}
{{--                    <a href="single-product.html" class="image"><img src="{{asset('clientBunker')}}/images/product-image/2.webp" alt="Cart product Image"></a>--}}
{{--                    <div class="content">--}}
...
{{--                </li>--}}
{{--                <li>--}}
{{--                    <a href="single-product.html" class="image"><img src="{{asset('clientBunker')}}/images/product-image/3.webp" alt="Cart product Image"></a>--}}
{{--                    <div class="content">--}}
