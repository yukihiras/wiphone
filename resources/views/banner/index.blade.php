            ...
            <div class="row">
                <div class="col-md-3 col-sm-6">
                    <div class="form-group">
                        <input type="text" name="search_ten_banner" class="form-control" placeholder="Tên banner" value="">
                    </div>
                </div>
                <div class="clearfix"></div>
                <div class="col-xs-12" style="text-align:center;">
                    <div class="form-group">
                        ...
                        <a href="{{ url('/user') }}" class="btn btn-default btn-sm "><i class="fa fa-remove"></i>
                            Clear </a>
                        <a href="/banner/add" class="btn btn-info btn-sm"><i class="ion-images" style="color:white;"></i>
                            Add new</a>
                    </div>
                </div>
            </div>
            ...
            <div class="double-scroll">
                <table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <td class="text-center"><img class="text-center" src="{{$item->image ? ''. Storage::url($item->image):'error image'}}" alt="your image" style="max-width: 200px; " class="img-responsive" /></td>
                        <td class="text-center"><a class="btn btn-info ion-edit" href="{{route('route_BackEnd_Banner_Detail', ['id'=> $item->id])}}"></a></td>
                        <td class="text-center"><a href=""><a onclick="return confirm('Bạn có muốn xoá')" class="btn btn-danger ion-ios-trash" href="{{route('route_BackEnd_Banner_Delete', ['id'=> $item->id])}}"></a></td>
                    </tr>
                    @endforeach
