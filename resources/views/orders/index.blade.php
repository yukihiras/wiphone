            ...
            <div class="row">
                <div class="col-md-3 col-sm-6">
                    <div class="form-group">
                        <input type="text" name="search_ten_khách hàng" class="form-control" placeholder="Tên khách hàng" value="">
                    </div>
                </div>
                <div class="clearfix"></div>
                <div class="col-xs-12" style="text-align:center;">
                    <div class="form-group">
                        ...
                        <a href="{{ url('/user') }}" class="btn btn-default btn-sm "><i class="fa fa-remove"></i>
                            Clear </a>
                        <a href="/orders/add" class="btn btn-info btn-sm"><i class="ion-ios-list" style="color:white;"></i>
                            Add new</a>
                    </div>
                </div>
            </div>
            ...
            <div class="double-scroll">
                <table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <td class="text-center" style="color:#333333;font-weight: bold;">{{$item->customerName}}</td>
                        <td class="text-center">{{$item->address}}</td>
                        <td class="text-center">{{$item->email}}</td>
                        <td class="text-center">{{$item->phoneNumber}}</td>
                        <td>{{$item->description}}</td>
                        <td class="text-center">{{$item->userName}}</td>
                        <td class="text-center"><a class="btn btn-info ion-edit" href="{{route('route_BackEnd_Orders_Detail', ['id'=> $item->id])}}"></a></td>
                        <td class="text-center"><a href=""><a onclick="return confirm('Bạn có muốn xoá')" class="btn btn-danger ion-ios-trash" href="{{route('route_BackEnd_Orders_Delete', ['id'=> $item->id])}}"></a></a></td>
                    </tr>
                    @endforeach
