                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-8">
                            <input type="text" name="customerName" id="customerName" class="form-control" value="@isset($request['customerName']){{ $request['customerName'] }}@endisset">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-8">
                            <input type="text" name="address" id="address" class="form-control" value="@isset($request['address']){{ $request['address'] }}@endisset">
                            <span id="mes_sdt"></span>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-8">
                            <input type="number" name="phoneNumber" id="phoneNumber" class="form-control" value="@isset($request['phoneNumber']){{ $request['phoneNumber'] }}@endisset">
                            <span id="mes_sdt"></span>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-8">
                            <input type="email" name="email" id="email" class="form-control" value="@isset($request['email']){{ $request['email'] }}@endisset">
                            <span id="mes_sdt"></span>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-8">
                            <textarea class="form-control" name="description" rows="10" cols="30" value="@isset($request['description']){{ $request['description'] }}@endisset"></textarea>
                            <span id="mes_sdt"></span>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-8">
                            <input type="number" name="totalPrice" id="totalPrice" class="form-control" value="@isset($request['totalPrice']){{ $request['totalPrice'] }}@endisset">
                            <span id="mes_sdt"></span>
                        </div>
                    </div>
